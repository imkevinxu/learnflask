# Django settings for learnflask project.
...
DATABASES = {
    'default': {
        ...
        'NAME':  'learnflask',                      # Or path to database file if using sqlite3.
        'USER': 'learnflask_user',                      # Not used with sqlite3.
        'PASSWORD': 'x88THzBoyG2eDjmg0Fosfa3s7QqmsV',                  # Not used with sqlite3.
...
SECRET_KEY = 'wiJRY{m`bz/6|`-<I-"%kp=S9Fq~aK[e_lT\`QIf]bwkQMR`{q'
...
ROOT_URLCONF = 'learnflask.urls'

WSGI_APPLICATION = 'learnflask.wsgi.application'
